  ...
  return (
    <div>
      ...
      <div className={styles.container}>
        ...
        <h2>LilFluttershy Store</h2>
        <link rel="preconnect" href="https://fonts.gstatic.com" />
        <ul className={styles.list}>{printshops()}</ul>
        selected order: {shop.name} {shop.price} {shop.Deliverycost}{" "}
        {shop.Delivery} {shop.imageurl}
        <h2>Add Order</h2>
        <ul className={styles.formadd}>
          ...
          <button
            ...
            onClick={() =>
              addshop(name, price, Deliverycost, Delivery, imageurl)
            }
          >
            Add New Products
          </button>
